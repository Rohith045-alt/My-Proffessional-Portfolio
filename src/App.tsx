        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="pt-6 flex items-center justify-center lg:justify-start gap-6 text-slate-400">
              <a href="https://www.linkedin.com/in/rohith-g-william-445425375/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-slate-800/80 hover:bg-blue-600 hover:text-white border border-blue-500/30 transition-all shadow-md">
                <FaLinkedin className="w-5 h-5" />
              </a>
              <a href="https://github.com/Rohith045-alt" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-slate-800/80 hover:bg-blue-600 hover:text-white border border-blue-500/30 transition-all shadow-md">
